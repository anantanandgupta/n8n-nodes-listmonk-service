...
import { getPaginationOptions, getSortingOptions } from './commonOptions';
...
const operationParameters: INodeProperties[] = [
  ...
  ...getPaginationOptions({
    show: {
      operation: [operations.list_get_all.key],
      resource: [resourceKeys.lists.key],
    },
  }),
  ...getSortingOptions({
        ...
        routing: {
          request: {
            ...
            qs: {
              ...
              per_page: '={{ $parameter["usePagination"] === true ? $parameter["perPage"] : "all" }}',
              order_by: '={{ $parameter["useSorting"] === true ? $parameter["sortField"] : undefined }}',
              order: '={{ $parameter["useSorting"] === true ? $parameter["sortDirection"] : undefined }}',
            },
          },
        },
      },
